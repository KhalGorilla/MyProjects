...
namespace CafeManagement
{
    public partial class Form1 : Form
    {
        ...
        {
            //btnTotal
            double lat= 1.20, mocha= 1.29, espr= 1.29, vale= 1.45, cappu= 1.70, afri= 1.50, mTea= 1.45, cTea= 1.10; //coffee prices
            double cCake= 1.30, rValvet= 1.20, bFor= 1.30, bCream= 1.90, lChoco= 1.50, kChoco= 1.40, cheese= 1.30, rain= 1.10;//cake prices
            double tax= 0.45;
